...
import {CloneTreeTransformer} from './CloneTreeTransformer';
import {
  FormalParameter,
  FunctionDeclaration,
  FunctionExpression,
...
/**
 * Adds JSDoc for type annotations
 */
export class ClosureTypeTransformer extends ParseTreeTransformer {
